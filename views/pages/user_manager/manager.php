                       ...
                       <?php
                         ...
                         if ($result->num_rows > 0) {
                            ...
                            // output data of each row
                              ...
                              <a href="?page=UserProfile&&user_id=<?php echo $id_edit ?>" data-placement="top" data-toggle="tooltip" title="ดูรายละเอียดข้อมูล" class="btn btn-info btn-sm veiw"><span class="fas fa-eye" aria-hidden="true"></span></a>
        ...
        $('#add_button').click(function(){
          ...
          $(document).on('submit', '#user_form', function(event){
            ...
            // var user_position = $('#user_position').val();
              ...
              $.ajax({
                url:"database/db_user_insert_change.php",
                method:'POST',
   ...
   <div id="dataModal" class="modal fade">
	<div class="modal-dialog modal-xl">
      ...
      <div class="modal-content">
            ...
            <h4 class="modal-title">เพิ่มข้อมูล User</h4>
