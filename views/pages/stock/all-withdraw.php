               ...
               <tr>
                 ...
                 <th>Action</th>
                      ...
                      // mysql_query("SET character_set_results=utf8");
                        $sql = "SELECT * FROM `tbl_withdraw` ORDER BY `tbl_withdraw`.`time` DESC";
                        ...
                        if ($result->num_rows > 0) {
                           ...
                           // output data of each row
                             ...
                             ?>
                            <td> 
                            <button onclick="window.location.href='?page=withdraw-detail&withdraw_id=<?=$row['withdraw_id'];?>'"  id="<?=$row["withdraw_id"];?>" name="<?=$row["user"];?>" data-placement="top" data-toggle="tooltip" title="ลบ"  class="btn btn-info btn-sm veiw">ดูรายละอียดการเบิก</button>
